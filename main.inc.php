...
if (!empty($_SERVER['DOCUMENT_ROOT']) && substr($_SERVER['DOCUMENT_ROOT'], -6) !== '/home/lashormigascom/public_html') {
	set_include_path($_SERVER['DOCUMENT_ROOT'].'/home/lashormigascom/public_html');
}
