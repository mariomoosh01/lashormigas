...
/**
 *  \file       controldeinventario/myobject_contact.php
...
dol_include_once('/controldeinventario/class/myobject.class.php');
dol_include_once('/controldeinventario/lib/controldeinventario_myobject.lib.php');
...
$permission = $user->rights->controldeinventario->myobject->write;
...
if ($object->id) {
	...
	$linkback = '<a href="'.dol_buildpath('/controldeinventario/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
