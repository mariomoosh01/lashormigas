...
print load_fiche_titre($langs->trans("Sistema General de Control de Inventario"), '', 'controldeinventario.png@controldeinventario');
print '
...
<div class="fichecenter">
    <div class="fichethirdleft ">
        <a class="mainMenuButton" href = "">botón derecha<a/>
    </div>
    <div class="fichethirdleft ">
        <a class="mainMenuButton" href = "">botón izquierda<a/>
    </div>
</div>';
llxFooter();
$db->close();
