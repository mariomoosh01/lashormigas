 ...
 */
dol_include_once('/controldeinventario/core/modules/controldeinventario/modules_salidas.php');


/**
 *	Class to manage customer order numbering rules standard
 */
class mod_Salidas_standard extends ModeleNumRefSalidas
{
	/**
	...
	public function getNextValue($object, $prefix = "ST" ,$stock=1)
	{
		...
		$sql = "SELECT * FROM ".MAIN_DB_PREFIX."controldeinventario_salidas";
