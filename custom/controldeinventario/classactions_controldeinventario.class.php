 ...
 */
class ActionsControlDeInventario
{
	/**
	...
	*/
	...
	public function emisionderequisicionescard($parameters, &$object, &$action, $hookmanager)
	{
		global $conf, $user, $langs;
		...
		/* print_r($parameters); print_r($object); echo "action: " . $action; */
		if (in_array($parameters['currentcontext'], array('emisionderequisicionescard'))) {		// do something only for the context 'somecontext1' or 'somecontext2'
			//aqui ensartamos los hooks que queremos ejecutar ;P
			print '<div class="dolibruh">hola que hace, programando o que hace?</div>';
		}
