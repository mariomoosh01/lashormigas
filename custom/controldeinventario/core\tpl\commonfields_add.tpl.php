...
for ($x=0;$x<count($tableFields);$x++)
		{	
			if($x==0){
				...
				$allCost_pesos = "SELECT t_cost FROM hor_controldeinventario_entradas WHERE tiporeq =".$isstock."AND YEAR(date_creation) = YEAR(CURDATE())" ;
				$sumaArticulosMNX=0;
				$sumaPrecioTotalMNX = 0.0;
