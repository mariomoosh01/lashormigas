 ...
 */
dol_include_once('/controldeinventario/core/modules/controldeinventario/modules_emisionderequisiciones.php');


/**
 *	Class to manage customer order numbering rules standard
 */
class mod_emisionderequisiciones_standard extends ModeleNumRefemisionderequisiciones
{
	/**
