...
class modControlDeInventario extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear datos del control de inventarios'; // Permission label
		$this->rights[$r][4] = 'emisionderequisiciones';
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar datos del control de inventarios'; // Permission label
		$this->rights[$r][4] = 'emisionderequisiciones';
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear entradas'; // Permission label
		$this->rights[$r][4] = 'entradas';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar entradas de productos'; // Permission label
		$this->rights[$r][4] = 'entradas';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		//salidas
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear salidas'; // Permission label
		$this->rights[$r][4] = 'salidas';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar salidas de productos'; // Permission label
		$this->rights[$r][4] = 'salidas';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		//familias
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear familias'; // Permission label
		$this->rights[$r][4] = 'familias';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar familias de productos'; // Permission label
		$this->rights[$r][4] = 'familias';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear grupos'; // Permission label
		$this->rights[$r][4] = 'grupos';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar grupos de productos'; // Permission label
		$this->rights[$r][4] = 'grupos';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear productos'; // Permission label
		$this->rights[$r][4] = 'inventariogeneral';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar productos'; // Permission label
		$this->rights[$r][4] = 'inventariogeneral';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear Unidades de medida'; // Permission label
		$this->rights[$r][4] = 'unidadmedida';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar Unidades de medida'; // Permission label
		$this->rights[$r][4] = 'unidadmedida';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		//Permiso Almacenes
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear Almacenes'; // Permission label
		$this->rights[$r][4] = 'almacenes';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar Unidades Almacenes'; // Permission label
		$this->rights[$r][4] = 'almacenes';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		// Inventario No Stock
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear inventario no stock'; // Permission label
		$this->rights[$r][4] = 'inventarions';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar inventario no stock'; // Permission label
		$this->rights[$r][4] = 'inventarions';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		// Inventario ANS
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear inventario Agroquímicos'; // Permission label
		$this->rights[$r][4] = 'inventarioans';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar inventario Agroquímicos'; // Permission label
		$this->rights[$r][4] = 'inventarioans';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear contadores'; // Permission label
		$this->rights[$r][4] = 'contadores';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar contadores'; // Permission label
		$this->rights[$r][4] = 'contadores';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
		...
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'Crear pruebas'; // Permission label
		$this->rights[$r][4] = 'pruebas';
		$this->rights[$r][5] = 'write'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->write)
		$r++;
		$this->rights[$r][0] = $this->numero . sprintf("%02d", $r + 1); // Permission id (must not be already used)
		$this->rights[$r][1] = 'modificar pruebas'; // Permission label
		$this->rights[$r][4] = 'pruebas';
		$this->rights[$r][5] = 'delete'; // In php code, permission will be checked by test if ($user->rights->controldeinventario->emisionderequisiciones->delete)
		$r++;
