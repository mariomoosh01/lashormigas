...
* Corregido un bug que NO actualizaba la base de datos cada vez que se agrega o remueve un producot de los artículos que no son STOCK, dando errores en el costo total
