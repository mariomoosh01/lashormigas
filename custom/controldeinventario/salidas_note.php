...
/**
 *  \file       salidas_note.php
 *  \ingroup    controldeinventario
 *  \brief      Tab for notes on Salidas
 */
...
$hookmanager->initHooks(array('salidasnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->controldeinventario->salidas->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Salidas'), $help_url);
