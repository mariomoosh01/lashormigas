...
/**
 * \file    test/phpunit/ControlDeInventarioFunctionalTest.php
...
/**
 * Class ControlDeInventarioFunctionalTest
 *
 ...
 *
 * @package Testcontroldeinventario
 */
class ControlDeInventarioFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modControlDeInventario')->click();
		} else {
			// Disable the module
			$this->byHref('modControlDeInventario')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/controldeinventario/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('controldeinventario/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/controldeinventario/admin/about.php');
		$this->authenticate();
		return $this->assertContains('controldeinventario/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('controldeinventariowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modControlDeInventario_ControlDeInventarioTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modControlDeInventario_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
