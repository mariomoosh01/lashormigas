...
if(!$action){
	...
	$currentYear = $mydate["year"]-2000;

	print '<a class ="mainMenuButton" 
	href="/custom/controldeinventario/inventarions_list.php?search_tiporeq=1&search_ref=NS'.$currentYear.'">
	<img src="/custom/controldeinventario/img/inventariogeneral.png" alt="" class="paddingright pictofixedwidth valignmiddle">
	Sistema de control de inventarios (No Stock)</a>';
	print '<br>';

	print '<a class ="mainMenuButton" 
	href="/custom/controldeinventario/inventarions_list.php?search_tiporeq=4&search_ref=OS'.$currentYear.'">
	<img src="/custom/controldeinventario/img/inventariogeneral.png" alt="" class="paddingright pictofixedwidth valignmiddle">
	Sistema de control de inventarios (OS)</a>';
	print '<br>';

	print '<a class ="mainMenuButton" 
	href="/custom/controldeinventario/inventarioans_list.php?search_ref=ANS'.$currentYear.'">
	<img src="/custom/controldeinventario/img/inventariogeneral.png" alt="" class="paddingright pictofixedwidth valignmiddle">
