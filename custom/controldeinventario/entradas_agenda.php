...
/**
 *  \file       entradas_agenda.php
 *  \ingroup    controldeinventario
 *  \brief      Tab of events on Entradas
 */
...
$hookmanager->initHooks(array('entradasagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		//print load_fiche_titre($langs->trans("ActionsOnEntradas"), '', '');
