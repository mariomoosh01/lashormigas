 ...
 */
class randomHormiga extends ModeleBoxes
{
	/**
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->boxlabel = $langs->transnoentitiesnoconv("Hormiga Lateral");
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("Hormiga aleatorea", $max);
		...
		$this->info_box_contents = array(
			0 => array( // First line
				0 => array( // First Column
					...
					text-align: center;
					">
						<img style="width=40%" width=400 src="/custom/controldeinventario/img/hormigatrabajando01.jpg"></p>
					',
