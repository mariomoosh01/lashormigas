...
print '<table class="tablaAbajo"><tr class="normalTableHeaderRow">';
...
foreach ($object->fields as $key => $val) {
	...
	print '<td class="tablaAbajoCelda center ';
	 if ($val['css']) {
	 	print ' '.$val['css'];
	 }
	print '">';

	print $object->showOutputField($val, $key, $value, '', '', '', $val['css']);
	print '</td>' ;
	// print '<tr><td';
	// print ' class="titlefield fieldname_'.$key;
