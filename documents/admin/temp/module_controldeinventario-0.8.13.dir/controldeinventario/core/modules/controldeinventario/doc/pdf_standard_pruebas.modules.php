...
/**
 *	Class to manage PDF template standard_pruebas
 */
class pdf_standard_pruebas extends ModelePDFPruebas
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_PRUEBAS_WITH_PICTURE))
		{
