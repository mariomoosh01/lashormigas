...
/**
 *  \file       salidas_contact.php
 *  \ingroup    controldeinventario
 *  \brief      Tab for contacts linked to Salidas
 */
...
$hookmanager->initHooks(array('salidascontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->controldeinventario->salidas->write;
...
$title = $langs->trans('Salidas')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
