...
/**
 *  \file       core/modules/controldeinventario/doc/pdf_standard.modules.php
 *  \ingroup    controldeinventario
 *  \brief      File of class to generate document from standard template
 */

dol_include_once('/controldeinventario/core/modules/controldeinventario/modules_inventariogeneral.php');
...
/**
 *	Class to manage PDF template standard_inventariogeneral
 */
class pdf_standard_inventariogeneral extends ModelePDFInventarioGeneral
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_inventariogeneral_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->controldeinventario->dir_output.'/pruebas') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->controldeinventario->dir_output.'/pruebas';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->controldeinventario->dir_output.'/pruebas/'.$objectref;
