...
/**
 *  \file       entradas_note.php
 *  \ingroup    controldeinventario
 *  \brief      Tab for notes on Entradas
 */
...
$hookmanager->initHooks(array('entradasnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permissiontoadd = $user->rights->controldeinventario->entradas->write; // Used by the include of actions_addupdatedelete.inc.php
...
$help_url = '';
llxHeader('', $langs->trans('Entradas'), $help_url);
