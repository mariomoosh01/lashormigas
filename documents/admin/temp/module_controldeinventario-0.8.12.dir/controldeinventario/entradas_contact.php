...
/**
 *  \file       entradas_contact.php
 *  \ingroup    controldeinventario
 *  \brief      Tab for contacts linked to Entradas
 */
...
$hookmanager->initHooks(array('entradascontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->controldeinventario->entradas->write;
...
$title = $langs->trans('Entradas')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
